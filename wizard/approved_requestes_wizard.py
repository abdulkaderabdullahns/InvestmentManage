...
class ApprovedRequestReportWizard(models.TransientModel):
    _name = 'approved_requestes.report.wizard'
    ...
    def get_report(self):
        ...
        return self.env.ref('bank.approved_requestes_report').report_action(self, data=data)


class ApprovedRequestReport(models.AbstractModel):
    _name = 'report.bank.approved_requestes_template'
